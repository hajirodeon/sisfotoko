...
$sqlcount = "SELECT beli.*, beli_detail.*, m_brg.*, m_brg.nama AS mbnm, ".
...
if ((empty($xbln1)) OR (empty($xthn1)))
	...
	if ($count != 0)
		...
		<td width="150"><strong><font color="'.$warnatext.'">No. Faktur</font></strong></td>
		...
		do
			...
			$y_supplier = balikin($data['supplier']);
		...
		<tr>
		<td>
		[<a href="lap_history_beli_prt.php?brgkd='.$brgkd.'&xbln1='.$xbln1.'&xthn1='.$xthn1.'" title="PRINT...!!"><img src="../../img/print.gif" border="0"></a>]
		</td>
		<td align="right">
