...
if ($_POST['btnHPS'])
	...
	for ($i=1; $i<=$jml;$i++)
		...
		//del
		mysqli_query($koneksi, "DELETE FROM m_kastumer ".
						"WHERE kd = '$kd'");
		}
...
if (($_POST['btnCRI']) OR ($_POST['kunci']))
	...
	if ((empty($katcari)) OR (empty($kunci)))
		...
		if ($katcari == "c01")
			{
			$sqlcount = "SELECT * FROM m_kastumer ".
...
function open_entry()
	{
	entry_window=dhtmlmodal.open(\'Entry Data Kastumer\',
	\'iframe\',
	\'kastumer_entry.php\',
	\'Entry Data Kastumer\',
...
function open_edit()
	{
	edit_window=dhtmlmodal.open(\'Edit Data Kastumer\',
	\'iframe\',
	\'kastumer_entry_edit.php\',
	\'Edit Data Kastumer\',
	\'width=900px,height=275px,center=1,resize=0,scrolling=0\');
...
if ($count != 0)
	...
	do {
		...
		<td width="5">
		<a href="#" onClick="edit_window=dhtmlmodal.open(\'Edit Data Kastumer\', \'iframe\', \'kastumer_entry_edit.php?s=edit&kd='.$kd.'\', \'Edit Data Kastumer\', \'width=900px,height=275px,center=1,resize=0,scrolling=0\');
		edit_window.onClose=function()
			{
			location.href=\''.$filenya.'\';
