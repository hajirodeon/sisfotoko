...
$sqlcount = "SELECT m_brg.*, m_kategori.*, m_satuan.*, stock_rusak.*, ".
				"stock_rusak.kd AS srkd, m_gudang.* ".
				"FROM m_brg, m_kategori, m_satuan, stock_rusak, m_gudang ".
				"WHERE stock_rusak.kd_brg = m_brg.kd ".
				"AND m_brg.kd_kategori = m_kategori.kd ".
				"AND m_brg.kd_satuan = m_satuan.kd ".
				"AND stock_rusak.kd_gudang = m_gudang.kd ".
