	...
	if ($s == "edit")
		...
		if ((empty($kode)) OR (empty($nama)))
			...
			if ($tcc > 1)
				...
				//update stock
				mysqli_query($koneksi, "UPDATE stock SET jml_gudang = '$jml_gudang', ".
								"jml_toko = '$jml_toko', ".
								"jml_min = '$jml_min', ".
								"hrg_beli = '$hrg_beli', ".
								"hrg_jual = '$hrg_jual', ".
		...
		if (empty($kode))
			...
			//jika telah isi
				...
				if (empty($nama))
					...
					mysqli_query($koneksi, "INSERT aINTO stock(kd, kd_brg, jml_toko, jml_gudang, jml_min, hrg_beli, hrg_jual, persen) VALUES ".
